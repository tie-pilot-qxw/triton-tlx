...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @cross_dim_partition(%arg0: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<i32> {tt.divisibility = 16 : i32}, %arg2: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg3: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg4: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg5: !tt.ptr<bf16> {tt.divisibility = 16 : i32}, %arg6: !tt.ptr<i8> {tt.divisibility = 16 : i32}, %arg7: f32, %arg8: i32, %arg9: i32 {tt.divisibility = 16 : i32}, %arg10: i32) attributes {noinline = false} {
    ...
    scf.if %21 {
      ...
      // CHECK: tt.experimental_descriptor_load {{.*}} -> tensor<64x128xbf16
      %25 = tt.experimental_descriptor_load %111[%23, %24] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x128xbf16>> -> tensor<128x128xbf16, #blocked1>
      ...
      %28 = tt.experimental_descriptor_load %112[%27, %24] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x128xbf16>> -> tensor<128x128xbf16, #blocked1>
      ...
      // CHECK: tt.experimental_descriptor_load {{.*}} -> tensor<64x128xbf16
      // CHECK: tt.experimental_descriptor_load {{.*}} -> tensor<64x128xbf16
      %33 = tt.experimental_descriptor_load %113[%23, %24] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x128xbf16>> -> tensor<128x128xbf16, #blocked1>
      ...
      // CHECK: tt.experimental_descriptor_load {{.*}} -> tensor<128x128xbf16
      %60 = tt.experimental_descriptor_load %112[%59, %24] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x128xbf16>> -> tensor<128x128xbf16, #blocked1>
      ...
      // CHECK: tt.experimental_descriptor_load {{.*}} -> tensor<128x128xbf16
      %65 = tt.experimental_descriptor_load %112[%27, %24] {async_task_id = dense<0> : vector<1xi32>} : !tt.tensordesc<tensor<128x128xbf16>> -> tensor<128x128xbf16, #blocked1>
      ...
      tt.experimental_descriptor_store %114[%73, %74], %71 {async_task_id = dense<[1, 2]> : vector<2xi32>} : !tt.tensordesc<tensor<128x128xbf16>>, tensor<128x128xbf16, #blocked1>
